...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(9)("62664410", content, false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    components: {
	        'yoyo-nav': __webpack_require__(13),
	        'yoyo-panels': __webpack_require__(18),
	        'class-hot-point-modal': __webpack_require__(38)
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(9)("45063b09", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(9)("8f9db384", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    components: {
	        statistics: __webpack_require__(22),
	        release: __webpack_require__(27),
	        feedback: __webpack_require__(32)
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "I:\\学习与工作\\大创项目\\yoyo\\yoyo-web\\src\\components\\statistics.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-23cfc9fa", Component.options)
	  } else {
	    hotAPI.reload("data-v-23cfc9fa", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(9)("ba6efbbe", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-23cfc9fa\",\"scoped\":true,\"hasInlineConfig\":false}!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./statistics.vue", function() {
	     var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-23cfc9fa\",\"scoped\":true,\"hasInlineConfig\":false}!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./statistics.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        show_class_hot_point: function show_class_hot_point(cid) {
	            console.log(cid);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-23cfc9fa", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(9)("0d362699", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(9)("d644e8c6", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "I:\\学习与工作\\大创项目\\yoyo\\yoyo-web\\src\\modals\\class_hot_point.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-44756937", Component.options)
	  } else {
	    hotAPI.reload("data-v-44756937", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(9)("4fb5fc29", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-44756937\",\"scoped\":true,\"hasInlineConfig\":false}!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./class_hot_point.vue", function() {
	     var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-44756937\",\"scoped\":true,\"hasInlineConfig\":false}!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./class_hot_point.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.hot-point-image[data-v-44756937]\n{\n    width:100%;\n}\n", ""]);
	...
	module.exports = {
	    ...
	    mounted: function mounted() {
	        ...
	        document.body.addEventListener('yoyo:get_statistics:ok', function (e) {
	            ...
	            while (max > 0) {
	                for (var _key in e.message) {
	                    if (e.message[_key] == max) {
	                        self.hot_points.push({
	                            index: _key,
	                            value: e.message[_key]
	                        });
	                    }
	                }
	                max--;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-44756937", module.exports)
	  }
	}
